...
from bitmex_websocket.constants import InstrumentChannels, BaseChannels#, SecureInstrumentChannels


BITMEX_API_KEY = os.environ.get('BITMEX_API_KEY')
BITMEX_API_SECRET = os.environ.get('BITMEX_API_SECRET')
#ws = BitMEXWebsocket(endpoint="https://testnet.bitmex.com/api/v1", symbol="XBTUSD", api_key=BITMEX_API_KEY, api_secret=BITMEX_API_SECRET)
...
def place_order(price=None, type="Limit", qty=1, stopPx=None, execInst = None):
